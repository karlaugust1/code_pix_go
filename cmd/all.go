...
import (
	...
	"github.com/karlaugust1/code_pix_go/application/kafka"
)
...
var allCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		kafka.Publish("msg", "test", producer, deliveryChan)
		go kafka.DeliveryReport(deliveryChan) //Send to a new thread managed by GO
