...
import (
	...
	"github.com/karlaugust1/code_pix_go/application/grpc/pb"
...
func (p *PixGrpcService) RegisterPixKey(ctx context.Context, in *pb.PixKeyResgistration) (*pb.PixKeyCreatedResult, error) {
