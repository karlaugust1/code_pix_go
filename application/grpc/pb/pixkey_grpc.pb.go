...
type PixServiceClient interface {
	RegisterPixKey(ctx context.Context, in *PixKeyResgistration, opts ...grpc.CallOption) (*PixKeyCreatedResult, error)
...
func (c *pixServiceClient) RegisterPixKey(ctx context.Context, in *PixKeyResgistration, opts ...grpc.CallOption) (*PixKeyCreatedResult, error) {
	out := new(PixKeyCreatedResult)
	err := c.cc.Invoke(ctx, "/github.com.karlaugus1.code_pix_go.PixService/RegisterPixKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pixServiceClient) Find(ctx context.Context, in *PixKey, opts ...grpc.CallOption) (*PixKeyInfo, error) {
	out := new(PixKeyInfo)
	err := c.cc.Invoke(ctx, "/github.com.karlaugus1.code_pix_go.PixService/Find", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PixServiceServer interface {
	RegisterPixKey(context.Context, *PixKeyResgistration) (*PixKeyCreatedResult, error)
...
func (UnimplementedPixServiceServer) RegisterPixKey(context.Context, *PixKeyResgistration) (*PixKeyCreatedResult, error) {
...
func _PixService_RegisterPixKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.karlaugus1.code_pix_go.PixService/RegisterPixKey",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PixServiceServer).RegisterPixKey(ctx, req.(*PixKeyResgistration))
	}
...
func _PixService_Find_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.karlaugus1.code_pix_go.PixService/Find",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var PixService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.karlaugus1.code_pix_go.PixService",
